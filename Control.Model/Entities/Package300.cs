...
{
    /// <summary>
    /// Concrete implementation of IPackage for the DAISY 3.0 format
    /// </summary>
    public class Package300 : IPackage
    {
        #region Fields (3)
        ...
        public Package300(Stream opfStream)
        {
            ...
            get
            {
                if (_bookId == null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            // Advise the user that the book has an invalid format.
        ...
        public string NcxXmlPath
        {
            get
            {
                if (_ncxXmlPath == null)
                {
                    ...
                    {
                        throw new InvalidPackageException("There should only be one NCX file referenced in the OPF");
                    }
                }
                return _ncxXmlPath;
            }
